...
\subsubsection[{interrupt\+\_\+exception(const char $\ast$msg, const Args \&...\+args)}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename... Args$>$ atmi\+::interrupt\+\_\+exception\+::interrupt\+\_\+exception (
