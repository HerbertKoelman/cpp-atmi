...
\subsubsection[{transaction(const char $\ast$service)}]{\setlength{\rightskip}{0pt plus 5cm}atmi\+::transaction\+::transaction (
...
\subsubsection[{acall(char $\ast$idata=\+N\+U\+L\+L, long ilen=0)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::acall (
\begin{DoxyParamCaption}
...
\index{acall@{acall}!atmi\+::transaction@{atmi\+::transaction}}
\subsubsection[{acall(buffer $\ast$buffer)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::acall (
\begin{DoxyParamCaption}
...
\subsubsection[{call(char $\ast$idata, long ilen, char $\ast$$\ast$odata, long $\ast$olen, int $\ast$urcode=\+N\+U\+L\+L, int retries=0, int delay=0)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::call (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{idata, }
\item[{long}]{ilen, }
...
\index{call@{call}!atmi\+::transaction@{atmi\+::transaction}}
\subsubsection[{call(buffer $\ast$buffer, int $\ast$urcode=\+N\+U\+L\+L, int retries=0, int delay=0)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::call (
\begin{DoxyParamCaption}
...
\index{call@{call}!atmi\+::transaction@{atmi\+::transaction}}
\subsubsection[{call(char $\ast$$\ast$idata=\+N\+U\+L\+L, long $\ast$ilen=0, int $\ast$urcode=\+N\+U\+L\+L, int retries=0, int delay=0)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::call (
\begin{DoxyParamCaption}
...
\subsubsection[{cancel(int cd=0)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::cancel (
\begin{DoxyParamCaption}
...
\subsubsection[{reply(char $\ast$$\ast$data, long $\ast$len, int $\ast$urcode=\+N\+U\+L\+L, int $\ast$cd=\+N\+U\+L\+L)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::reply (
\begin{DoxyParamCaption}
...
\index{reply@{reply}!atmi\+::transaction@{atmi\+::transaction}}
\subsubsection[{reply(buffer $\ast$buffer, int $\ast$urcode=\+N\+U\+L\+L, int $\ast$cd=\+N\+U\+L\+L)}]{\setlength{\rightskip}{0pt plus 5cm}int atmi\+::transaction\+::reply (
\begin{DoxyParamCaption}
\item[{{\bf atmi\+::buffer} $\ast$}]{buffer, }
\item[{int $\ast$}]{urcode = {\ttfamily NULL}, }
\item[{int $\ast$}]{cd = {\ttfamily NULL}}
