...
public:
	...
	*/
    unsigned int get_value() const { return n; }
};
...
public:
	...
	*/
    unsigned int get_max_workers() const { return this->max_concurrent_workers; }
    /**
	* accessors
	*
	* @return current number of permanent worker.
	*/
	unsigned int get_permanent_workers() const { return this->number_of_permanent_workers; }
    /**
	* accessors
	*
	* @return number of working workers.
	*/
	unsigned int get_current_workers() const { return b_cond.get_value(); }
...
/**
 ...
 /**
	...
	*/
    bool is_working() const { return (this->Job != (Runnable *)0); }
